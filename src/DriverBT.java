...
{ 
	...
	/**-------------------------------------------------------------------- */
	/**Task 4: Create a tree case as shown in assignment 3*/ //done
	...
	{ 
		...
		// Subtrees:
		BinaryTree<String> zTree = new BinaryTree<>("Z", null, null);
		BinaryTree<String> bTree = new BinaryTree<>("B", dTree, nTree);
		BinaryTree<String> cTree = new BinaryTree<>("C", zTree, null);
