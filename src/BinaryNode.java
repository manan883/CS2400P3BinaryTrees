class BinaryNode<T>
{
   ...
   {
	   //check if child exists on both sides then call the method from that child using recursive 
	   if(leftChild != null) {
   ...
   public int getHeight_binaryNodeMethod()
   {
	      ...
	      while(true) {
	    	  ...
	    	  if(leftChild != null) {
	    		  l = leftChild.getHeight_binaryNodeMethod();
	    	  }
	    	  if(rightChild != null) {
	    		  r = rightChild.getHeight_binaryNodeMethod();
	    	  }
