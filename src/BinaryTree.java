public class BinaryTree<T> implements BinaryTreeInterface<T>
{
    ...
    *     . In BinaryTree.java
    *          1. public void postorderTraverse(); done
    *          2. private void postorderTraverse(BinaryNode<T> node) done
    *          3. public void postorderTraverse_callBinaryNodeMethod() doesn't work
    *     . In BinaryNode.java
    *          4. public void postorderTraverse_binaryNodeMethod() done
    ...
    * prints (using post-order traversal) all nodes in the "whole" tree */
   public postorderTraverse_callBinaryNodeMethod()
   {
...
//empty  comment
    ...
    *     . In BinaryTree.java
    *          1. public int getHeight_callBinaryNodeMethod() done
    *     . In BinaryNode.java
    *          2. public int getHeight_binaryNodeMethod() done
    ...
    *     . In BinaryTree.java
    *          1. public int getNumberOfNodes() done
    *          2. private int getNumberOfNodes(BinaryNode<T> node) done
   ...
   private int getNumberOfNodes(BinaryNode<T> node)
   {
      ...
      if(node != null)
      {
         nodenum = 1 + getNumberOfNodes(node.getLeftChild()) + getNumberOfNodes(node.getRightChild());
      }
       return nodenum;
   } // end getNumberOfNodes
